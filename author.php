			...
			<div id="content" class="clearfix row">
				...
				<div id="main" class="col-md-8 clearfix" role="main">
					...
					<h1 class="archive_title h2">
						<span><?php _e("Posts By:", "ig2d"); ?></span>
						<?php
					...
					<?php while ( have_posts() ) : the_post(); ?>
						...
						<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article">
							...
							<header>
								...
								<p class="meta"><?php _e("Posted", "ig2d"); ?> <time datetime="<?php echo the_time('Y-m-j'); ?>" pubdate><?php the_time(); ?></time> <?php _e("by", "ig2d"); ?> <?php the_author_posts_link(); ?> &amp; <?php _e("filed under", "ig2d"); ?> <?php the_category(', '); ?>.</p>
							</header>

							<section class="post_content">
								<?php the_post_thumbnail( 'ig2d-featured' ); ?>
